...
namespace UnityEngine.UI
{
    ...
    /// </remarks>
    public class InvertMaskable : UIBehaviour, ICanvasRaycastFilter, IMaterialModifier
    {
        [NonSerialized]
        ...
        public virtual Material GetModifiedMaterial(Material baseMaterial)
        {
            ...
            int desiredStencilBit = 1 << m_MaskId;


            //otherwise we need to be a bit smarter and set some read / write masks
            var maskMaterial2 = StencilMaterial.Add(baseMaterial, desiredStencilBit, StencilOp.Replace, CompareFunction.NotEqual, m_ShowMaskGraphic ? ColorWriteMask.All : 0, desiredStencilBit, desiredStencilBit);
            StencilMaterial.Remove(m_MaskMaterial);
